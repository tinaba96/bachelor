...
class FlowNetSD(nn.Module):
    def __init__(self, args, batchNorm=True):
        ...
        self.conv0   = qconv(6,   64)
        self.conv1   = qconv(64,   64, stride=2)
        self.conv1_1 = qconv(64,   128)
        self.conv2   = qconv(128,  128, stride=2)
        self.conv2_1 = qconv(128,  128)
        self.conv3   = qconv(128,  256, stride=2)
        ...
        self.deconv3 = qdeconv(770,128)
        self.deconv2 = qdeconv(386,64)
