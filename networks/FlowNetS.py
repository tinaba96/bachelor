...
class FlowNetS(nn.Module):
    def __init__(self, args, input_channels = 12, output_channels = 2, batchNorm=True):
        super(FlowNetS,self).__init__()

        self.batchNorm = batchNorm
        self.conv1   = qconv(input_channels,   64, kernel_size=7, stride=2)
        self.conv2   = qconv(64,  128, kernel_size=5, stride=2)
        self.conv3   = qconv(128,  256, kernel_size=5, stride=2)
        self.conv3_1 = qconv(256,  256)
        ...
        self.deconv4 = qdeconv(1024+output_channels,256)
        self.deconv3 = qdeconv( 768+output_channels,128)
        self.deconv2 = qdeconv( 384+output_channels, 64)
